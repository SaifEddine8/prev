        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                HomeScreenView(title: 'Home',isSetected: selectedcategory==0,onTap: () => setState(() {
                  selectedcategory=0;
                }),),
                HomeScreenView(title: 'Category',isSetected: selectedcategory==1,onTap: () => setState(() {
                  selectedcategory=1;
                }),),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('See All',style: TextStyle(color: ColorsClass.primaryColor),)
                                ...
                                GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3,crossAxisSpacing: 10,mainAxisSpacing: 10,mainAxisExtent: 250),
